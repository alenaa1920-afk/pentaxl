...
export function SiteHeader() {
  ...
  return (
    <header className="border-line bg-void/80 sticky top-0 z-40 border-b backdrop-blur-md">
      <Container>
        <div className="flex h-16 items-center justify-between gap-6">
          ...
          <Drawer.Root>
            ...
            <Drawer.Portal>
              <Drawer.Overlay className="bg-void/70 fixed inset-0 z-50 backdrop-blur-sm" />
              <Drawer.Content
                aria-label="Menu"
                className="border-line bg-panel fixed inset-x-0 bottom-0 z-50 flex max-h-[85vh] flex-col border-t pb-8 outline-none"
              >
